...
window.AMC_MAPS=function AMC_MAPS(ctx){
 ...
 const FAC={full:['equip','smith','tool','rune','jewel','alchemy','bank','market','church','guild'],small:['equip','smith','tool','rune','alchemy','guild'],outpost:['tool','rune','guild']};
 const LABEL={equip:'装備屋',smith:'鍛冶屋',tool:'道具屋',rune:'ルーン店',jewel:'宝飾店',alchemy:'錬金店',bank:'銀行',market:'マーケット',church:'教会',guild:'冒険者ギルド',stone:'謎の石碑'};
