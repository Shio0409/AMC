...
window.AMC_MAPS=function AMC_MAPS(ctx){
 ...
 const FAC={full:['equip','smith','tool','rune','jewel','bank','market','church','guild','stone'],small:['equip','smith','tool','rune','guild','stone'],outpost:['tool','rune','guild','stone']};
 const LABEL={equip:'装備屋',smith:'鍛冶屋',tool:'道具屋',rune:'ルーン店',jewel:'宝飾店',bank:'銀行',market:'マーケット',church:'教会',guild:'冒険者ギルド',stone:'現世の石碑'};
